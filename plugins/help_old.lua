...
local function run(msg, matches)
  ...
  if matches[1] == "!hhelp" then
    return telegram_help()
  elseif matches[1] == "!hhelp all" then
...
return {
  ...
  usage = {
    "!hhelp: Show list of plugins.",
    "!hhelp all: Show all commands for every plugin.",
    "!hhelp [plugin name]: Commands for that plugin.",
    "!hhelp [number]: Commands for that plugin. Type !help to get the plugin number."
  },
  patterns = {
    "^!hhelp$",
    "^!hhelp all",
